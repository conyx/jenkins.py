 ...
 * @see hudson.scm.SCMDescriptor
 */
public abstract class SCMDescriptorPW<T extends SCM> extends SCMDescriptor<T> {
	...
	private void initPython() {
		if (pexec == null) {
			...
			functions[0] = "load";
			functions[1] = "is_browser_reusable";
			functions[2] = "is_applicable";
			functions[3] = "get_browser_descriptors";
			functions[4] = "get_id";
			functions[5] = "get_t";
	...
	public SCMDescriptorPW(Class<T> clazz, Class<? extends RepositoryBrowser> repositoryBrowser) {
		super(clazz, repositoryBrowser);
	}

	public SCMDescriptorPW(Class<? extends RepositoryBrowser> repositoryBrowser) {
	...
	public boolean isBrowserReusable(T x, T y) {
		...
		if (pexec.isImplemented(1)) {
			return pexec.execPythonBool("is_browser_reusable", x, y);
		} else {
			return super.isBrowserReusable(x, y);
		}
	}
	...
	public boolean isApplicable(AbstractProject project) {
		...
		if (pexec.isImplemented(2)) {
			return pexec.execPythonBool("is_applicable", project);
		} else {
	...
	public List<Descriptor<RepositoryBrowser<?>>> getBrowserDescriptors() {
		...
		if (pexec.isImplemented(3)) {
			return (List) pexec.execPython("get_browser_descriptors");
		} else {
			return super.getBrowserDescriptors();
		}
	}
	...
	public SCM newInstance(StaplerRequest req) throws FormException {
		...
		if (pexec.isImplemented(14)) {
			return (SCM) pexec.execPython("new_instance", req);
		} else {
	...
	public SCM newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		...
		if (pexec.isImplemented(15)) {
			return (SCM) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public boolean superIsBrowserReusable(T x, T y) {
		return super.isBrowserReusable(x, y);
	}

	public boolean superIsApplicable(AbstractProject project) {
		return super.isApplicable(project);
	}

	public List<Descriptor<RepositoryBrowser<?>>> superGetBrowserDescriptors() {
		return super.getBrowserDescriptors();
	}
	...
	public SCM superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public SCM superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

 ...
 * @see jenkins.mvn.SettingsProviderDescriptor
 */
public abstract class SettingsProviderDescriptorPW extends SettingsProviderDescriptor {
	...
	@Override
	public Class<SettingsProvider> getT() {
		initPython();
	...
	@Override
	public SettingsProvider newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(10)) {
			return (SettingsProvider) pexec.execPython("new_instance", req);
		} else {
	...
	@Override
	public SettingsProvider newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		initPython();
		if (pexec.isImplemented(11)) {
			return (SettingsProvider) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public Class<SettingsProvider> superGetT() {
		return super.getT();
	}
	...
	public SettingsProvider superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public SettingsProvider superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

 ...
 * @see hudson.tasks.BuildStepDescriptor
 */
public abstract class BuildStepDescriptorPW<T extends BuildStep & Describable<T>> extends BuildStepDescriptor<T> {
	...
	public BuildStepDescriptorPW(Class<? extends T> clazz) {
		super(clazz);
	}

	public BuildStepDescriptorPW() {
		super();
	}
	...
	public T newInstance(StaplerRequest req) throws FormException {
		...
		if (pexec.isImplemented(10)) {
			return (T) pexec.execPython("new_instance", req);
		} else {
	...
	public T newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		...
		if (pexec.isImplemented(11)) {
			return (T) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public T superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public T superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

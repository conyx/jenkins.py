 ...
 * @see hudson.model.ViewDescriptor
 */
public abstract class ViewDescriptorPW extends ViewDescriptor {
	...
	private void initPython() {
		if (pexec == null) {
			...
			functions[1] = "do_auto_complete_copy_new_item_from";
			functions[2] = "get_columns_descriptors";
			functions[3] = "get_job_filters_descriptors";
			functions[4] = "get_id";
			functions[5] = "get_t";
	...
	public ViewDescriptorPW(Class<? extends View> clazz) {
		super(clazz);
	}

	public ViewDescriptorPW() {
		super();
	}
	...
	public AutoCompletionCandidates doAutoCompleteCopyNewItemFrom(@QueryParameter final String value) {
		...
		if (pexec.isImplemented(1)) {
			return (AutoCompletionCandidates) pexec.execPython("do_auto_complete_copy_new_item_from", value);
		} else {
			return super.doAutoCompleteCopyNewItemFrom(value);
		}
	}
	...
	public List<Descriptor<ViewJobFilter>> getJobFiltersDescriptors() {
		...
		if (pexec.isImplemented(3)) {
			return (List) pexec.execPython("get_job_filters_descriptors");
		} else {
			return super.getJobFiltersDescriptors();
		}
	}
	...
	@Override
	public View newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(14)) {
			return (View) pexec.execPython("new_instance", req);
		} else {
	...
	@Override
	public View newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		initPython();
		if (pexec.isImplemented(15)) {
			return (View) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public AutoCompletionCandidates superDoAutoCompleteCopyNewItemFrom(@QueryParameter final String value) {
		return super.doAutoCompleteCopyNewItemFrom(value);
	}
	...
	public List<Descriptor<ViewJobFilter>> superGetJobFiltersDescriptors() {
		return super.getJobFiltersDescriptors();
	}
	...
	public View superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public View superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

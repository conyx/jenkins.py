 ...
 * @see jenkins.scm.SCMCheckoutStrategyDescriptor
 */
public abstract class SCMCheckoutStrategyDescriptorPW extends SCMCheckoutStrategyDescriptor {
	...
	public SCMCheckoutStrategyDescriptorPW(Class<? extends SCMCheckoutStrategy> clazz) {
		super(clazz);
	}

	public SCMCheckoutStrategyDescriptorPW() {
		super();
	}
	...
	@Override
	public Class<SCMCheckoutStrategy> getT() {
		initPython();
	...
	@Override
	public SCMCheckoutStrategy newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(10)) {
			return (SCMCheckoutStrategy) pexec.execPython("new_instance", req);
		} else {
	...
	@Override
	public SCMCheckoutStrategy newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		initPython();
		if (pexec.isImplemented(11)) {
			return (SCMCheckoutStrategy) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public Class<SCMCheckoutStrategy> superGetT() {
		return super.getT();
	}
	...
	public SCMCheckoutStrategy superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public SCMCheckoutStrategy superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

 ...
 * @see hudson.tools.ToolInstallerDescriptor
 */
public abstract class ToolInstallerDescriptorPW<T extends ToolInstaller> extends ToolInstallerDescriptor<T> {
	...
	@Override
	public ToolInstaller newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(11)) {
			return (ToolInstaller) pexec.execPython("new_instance", req);
		} else {
	...
	public boolean superIsApplicable(Class<? extends ToolInstallation> toolType) {
		return super.isApplicable(toolType);
	}
	...
	public Class<ToolInstaller> superGetT() {
		return super.getT();
	}
	...
	public ToolInstaller superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public ToolInstaller superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

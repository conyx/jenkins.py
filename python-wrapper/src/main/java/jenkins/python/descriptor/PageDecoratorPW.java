 ...
 * @see hudson.model.PageDecorator
 */
public abstract class PageDecoratorPW extends PageDecorator {
	...
	public PageDecoratorPW(Class<? extends PageDecorator> yourClass) {
		super(yourClass);
	}

	public PageDecoratorPW() {
		super();
	}
	...
	@Override
	public Class<PageDecorator> getT() {
		initPython();
	...
	@Override
	public PageDecorator newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(11)) {
			return (PageDecorator) pexec.execPython("new_instance", req);
		} else {
	...
	@Override
	public PageDecorator newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		initPython();
		if (pexec.isImplemented(12)) {
			return (PageDecorator) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public Class<PageDecorator> superGetT() {
		return super.getT();
	}
	...
	public PageDecorator superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public PageDecorator superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

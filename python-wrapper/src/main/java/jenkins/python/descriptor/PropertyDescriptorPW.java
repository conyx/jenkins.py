 ...
 * @see hudson.tools.PropertyDescriptor
 */
public abstract class PropertyDescriptorPW<P extends Describable<P>, T> extends PropertyDescriptor<P, T> {
	...
	public PropertyDescriptorPW(Class<? extends P> clazz) {
		super(clazz);
	}

	public PropertyDescriptorPW() {
		super();
	}
	...
	public boolean isApplicable(Class<? extends T> targetType) {
		...
		if (pexec.isImplemented(0)) {
			return pexec.execPythonBool("is_applicable", targetType);
		} else {
			return super.isApplicable(targetType);
		}
	}
	...
	@Override
	public P newInstance(StaplerRequest req) throws FormException {
		initPython();
		if (pexec.isImplemented(11)) {
			return (P) pexec.execPython("new_instance", req);
		} else {
	...
	@Override
	public P newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		initPython();
		if (pexec.isImplemented(12)) {
			return (P) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public boolean superIsApplicable(Class<? extends T> targetType) {
		return super.isApplicable(targetType);
	}
	...
	public P superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

	public P superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

 ...
 * @see hudson.model.JobPropertyDescriptor
 */
public abstract class JobPropertyDescriptorPW extends JobPropertyDescriptor {
	...
	public JobPropertyDescriptorPW(Class<? extends JobProperty<?>> clazz) {
		super(clazz);
	}

	public JobPropertyDescriptorPW() {
		super();
	}
	...
	public JobProperty<?> newInstance(StaplerRequest req, JSONObject formData) throws FormException {
		...
		if (pexec.isImplemented(0)) {
			return (JobProperty) pexec.execPython("new_instance", req, formData);
		} else {
	...
	public boolean isApplicable(Class<? extends Job> jobType) {
		...
		if (pexec.isImplemented(1)) {
			return pexec.execPythonBool("is_applicable", jobType);
		} else {
	...
	public JobProperty<?> newInstance(StaplerRequest req) throws FormException {
		...
		if (pexec.isImplemented(12)) {
			return (JobProperty) pexec.execPython("new_instance", req);
		} else {
	...
	public JobProperty<?> superNewInstance(StaplerRequest req, JSONObject formData) throws FormException {
		return super.newInstance(req, formData);
	}

	public boolean superIsApplicable(Class<? extends Job> jobType) {
		return super.isApplicable(jobType);
	}
	...
	public Class<JobProperty<?>> superGetT() {
		return super.getT();
	}
	...
	public JobProperty<?> superNewInstance(StaplerRequest req) throws FormException {
		return super.newInstance(req);
	}

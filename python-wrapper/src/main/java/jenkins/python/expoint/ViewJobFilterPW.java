 ...
 * @see hudson.views.ViewJobFilter
 */
public abstract class ViewJobFilterPW extends ViewJobFilter {
	...
	public List<TopLevelItem> filter(List<TopLevelItem> added, List<TopLevelItem> all, View filteringView) {
		initPython();
		return (List) pexec.execPython("filter", added, all, filteringView);
	}
	...
	public Descriptor<ViewJobFilter> superGetDescriptor() {
		return super.getDescriptor();
	}

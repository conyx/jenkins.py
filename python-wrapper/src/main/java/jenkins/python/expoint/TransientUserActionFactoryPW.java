 ...
 * @see hudson.model.TransientUserActionFactory
 */
public abstract class TransientUserActionFactoryPW extends TransientUserActionFactory {
	...
	public Collection<? extends Action> superCreateFor(User target) {
		return super.createFor(target);
	}

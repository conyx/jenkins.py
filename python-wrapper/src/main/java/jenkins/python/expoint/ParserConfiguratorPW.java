 ...
 * @see hudson.util.io.ParserConfigurator
 */
public abstract class ParserConfiguratorPW extends ParserConfigurator {
	...
	public void configure(SAXReader reader, Object context) {
		...
		if (pexec.isImplemented(0)) {
			pexec.execPythonVoid("configure", reader, context);
		} else {
			super.configure(reader, context);
		}
	}

	public void superConfigure(SAXReader reader, Object context) {
		super.configure(reader, context);
	}

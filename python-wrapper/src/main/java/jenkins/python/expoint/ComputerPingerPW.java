 ...
 * @see hudson.model.ComputerPinger
 */
public abstract class ComputerPingerPW extends ComputerPinger {
	...
	private void initPython() {
		if (pexec == null) {
			...
			jMethods[0] = "isReachable";
			String[] pFuncs = new String[1];
			pFuncs[0] = "is_reachable";
			Class[][] argTypes = new Class[1][];
			argTypes[0] = new Class[2];
			argTypes[0][0] = InetAddress.class;
	...
	public boolean isReachable(InetAddress ia, int timeout) throws IOException {
		initPython();
		return pexec.execPythonBool("is_reachable", ia, DataConvertor.fromInt(timeout));
	}
